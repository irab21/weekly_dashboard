...
if st.sidebar.checkbox('Final Score',True,key=6):
	...
	fig5=px.funnel(final_score,x=["Amit's Team","Talib's Team","Digital Team","Akanksha's Team","Manpreet's Team","Ravleen's Team","Functional Team","Deepa's Team"],y=[3.76,4.16,4.23,4.27,5.12,6.12,6.18,7.22],height=600)
