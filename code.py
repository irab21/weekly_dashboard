...
if st.sidebar.checkbox('Interview Ratio Scale',True,key=5):
	...
	st.write('\n\n')
	st.write('Please note that the numbers are denoted on scientific notations hence numbers less than 1 that are **0.583** is given as 580m and ***0.938*** is given as 940m')
