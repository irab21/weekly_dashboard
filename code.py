...
if st.sidebar.checkbox('Interview Ratio Scale',True,key=5):
	...
	st.write('\n\n')
	sr.write('Please note that the numbers are denoted on scientific notations hence numbers less than 1 that are **0.784*** is given as 780m and ***0.833*** is given as 830m')
...
if st.sidebar.checkbox('Final Score',True,key=6):
	...
	fig5=px.funnel(y=["Amit's Team","Talib's Team","Digital Team","Akanksha's Team","Manpreet's Team","Ravleen's Team","Functional Team","Deepa's Team"],x=[3.76,4.16,4.23,4.27,5.12,6.12,6.18,7.22],orientation='h')
